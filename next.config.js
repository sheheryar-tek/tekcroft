...
const nextConfig = {
  ...
  async headers() {
    ...
    return [
      ...
      { source: "/tekcroft-local-seo.:hash.js", headers: immutable },
      { source: "/tekcroft-on-page-seo.:hash.js", headers: immutable },
      {
        source: "/tekcroft-google-business-profile-optimization.:hash.js",
        headers: immutable,
      },
      {
