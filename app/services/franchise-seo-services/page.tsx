...
export default function FranchiseSeoServicesPage() {
  const html = fs.readFileSync(
    path.join(process.cwd(), "lib", "franchise-seo-body.html"),
    "utf8"
  );
  ...
  return (
    <>
      ...
      />
      <Homepage html={html} />
      <Script src={assets.franchiseSeo} strategy="afterInteractive" />
    </>
  );
}
