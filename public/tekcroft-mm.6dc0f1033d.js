...
var SERVICES = [
  { title:"SEO", href:"#services", icon:"chart", img:"team",
    items:[
      ...
      {name:"On-Page SEO Services", href:"/services/on-page-seo", note:"Titles, content and internal links.", img:"meeting"},
  ...
  { title:"Web and Software Development", href:"#services", icon:"code", img:"laptops",
    items:[
      ...
      {name:"Software Development Services", href:"/services/custom-software-development", note:"Custom platforms and internal tools.", img:"devs"},
